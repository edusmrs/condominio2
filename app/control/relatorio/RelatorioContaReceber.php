...
class RelatorioContaReceber extends TPage
{
    ...
    function onGenerate()
    {
        try
        {
            ...
            // define the query
            $query = 'SELECT conta.descricao, conta_receber.valor, conta_receber.data_vencimento, conta_receber.valor_recebido, pessoa.nome                            
                      FROM conta_receber, pessoa, conta
                      WHERE pessoa.id = conta_receber.pessoa_id AND
                            conta.id = conta_receber.conta_id AND
